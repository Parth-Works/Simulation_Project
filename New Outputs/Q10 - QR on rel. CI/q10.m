...
%  the impact of the size of LOAD/QUEUING RATIO on the Relative sizes of the confidence intervals

%%       Initialisation     %%%

% lag1Corr
lag1Corr_Load2 = [];lag1Corr_Load5 = [];lag1Corr_Load10 = [];
lag1Corr_QR2 = [];lag1Corr_QR5 = [];lag1Corr_QR10 = [];
...
[R90_Load2(1), R95_Load2(1), R99_Load2(1)] = RelconfidenceIntv(load_k2s40)

% Queue Ratio

m_QueueRatio2(1)=mean(queue_ratio_k2s40);
lag1Corr_QueueRatio2(1) = autocorrelation(queue_ratio_k2s40)
[R90_QR2(1), R95_QR2(1), R99_QR2(1)] = RelconfidenceIntv(queue_ratio_k2s40)
...
[R90_Load2(2), R95_Load2(2), R99_Load2(2)] = RelconfidenceIntv(load_k2s60)

% Queue Ratio

m_QueueRatio2(2)=mean(queue_ratio_k2s60);
lag1Corr_QueueRatio2(2) = autocorrelation(queue_ratio_k2s60)
[R90_QR2(2), R95_QR2(2), R99_QR2(2)] = RelconfidenceIntv(queue_ratio_k2s60)
...
[R90_Load2(3), R95_Load2(3), R99_Load2(3)] = RelconfidenceIntv(load_k2s80)

% Queue Ratio

m_QueueRatio2(3)= mean(queue_ratio_k2s80);
lag1Corr_QueueRatio2(3) = autocorrelation(queue_ratio_k2s80)
[R90_QR2(3), R95_QR2(3), R99_QR2(3)] = RelconfidenceIntv(queue_ratio_k2s80)
...
[R90_Load2(4), R95_Load2(4), R99_Load2(4)] = RelconfidenceIntv(load_k2s100)

% Queue Ratio

m_QueueRatio2(4)=mean(queue_ratio_k2s100);
lag1Corr_QueueRatio2(4) = autocorrelation(queue_ratio_k2s100)
[R90_QR2(4), R95_QR2(4), R99_QR2(4)] = RelconfidenceIntv(queue_ratio_k2s100)
...
[R90_Load2(5), R95_Load2(5), R99_Load2(5)] = RelconfidenceIntv(load_k2s120)

% Queue Ratio

m_QueueRatio2(5)=mean(queue_ratio_k2s120);
lag1Corr_QueueRatio2(5) = autocorrelation(queue_ratio_k2s120)
[R90_QR2(5), R95_QR2(5), R99_QR2(5)] = RelconfidenceIntv(queue_ratio_k2s120)
...
[R90_Load2(6), R95_Load2(6), R99_Load2(6)] = RelconfidenceIntv(load_k2s150)

% Queue Ratio

m_QueueRatio2(6)=mean(queue_ratio_k2s150);
lag1Corr_QueueRatio2(6) = autocorrelation(queue_ratio_k2s150)
[R90_QR2(6), R95_QR2(6), R99_QR2(6)] = RelconfidenceIntv(queue_ratio_k2s150)
...
[R90_Load5(1), R95_Load5(1), R99_Load5(1)] = RelconfidenceIntv(load_k5s40)

% Queue Ratio

m_QueueRatio5(1)=mean(queue_ratio_k5s40);
lag1Corr_QueueRatio5(1) = autocorrelation(queue_ratio_k5s40)
[R90_QR5(1), R95_QR5(1), R99_QR5(1)] = RelconfidenceIntv(queue_ratio_k5s40)
...
[R90_Load5(2), R95_Load5(2), R99_Load5(2)] = RelconfidenceIntv(load_k5s60)

% Queue Ratio

m_QueueRatio5(2)=mean(queue_ratio_k5s60);
lag1Corr_QueueRatio5(2) = autocorrelation(queue_ratio_k5s60)
[R90_QR5(2), R95_QR5(2), R99_QR5(2)] = RelconfidenceIntv(queue_ratio_k5s60)
...
[R90_Load5(3), R95_Load5(3), R99_Load5(3)] = RelconfidenceIntv(load_k5s80)

% Queue Ratio

m_QueueRatio5(3)= mean(queue_ratio_k5s80);
lag1Corr_QueueRatio5(3) = autocorrelation(queue_ratio_k5s80)
[R90_QR5(3), R95_QR5(3), R99_QR5(3)] = RelconfidenceIntv(queue_ratio_k5s80)
...
[R90_Load5(4), R95_Load5(4), R99_Load5(4)] = RelconfidenceIntv(load_k5s100)

% Queue Ratio

m_QueueRatio5(4)=mean(queue_ratio_k5s100);
lag1Corr_QueueRatio5(4) = autocorrelation(queue_ratio_k5s100)
[R90_QR5(4), R95_QR5(4), R99_QR5(4)] = RelconfidenceIntv(queue_ratio_k5s100)
...
[R90_Load5(5), R95_Load5(5), R99_Load5(5)] = RelconfidenceIntv(load_k5s120)

% Queue Ratio

m_QueueRatio5(5)=mean(queue_ratio_k5s120);
lag1Corr_QueueRatio5(5) = autocorrelation(queue_ratio_k5s120)
[R90_QR5(5), R95_QR5(5), R99_QR5(5)] = RelconfidenceIntv(queue_ratio_k5s120)
...
[R90_Load5(6), R95_Load5(6), R99_Load5(6)] = RelconfidenceIntv(load_k5s150)

% Queue Ratio

m_QueueRatio5(6)=mean(queue_ratio_k5s150);
lag1Corr_QueueRatio5(6) = autocorrelation(queue_ratio_k5s150)
[R90_QR5(6), R95_QR5(6), R99_QR5(6)] = RelconfidenceIntv(queue_ratio_k5s150)
...
[R90_Load10(1), R95_Load10(1), R99_Load10(1)] = RelconfidenceIntv(load_k10s40)

% Queue Ratio

m_QueueRatio10(1)=mean(queue_ratio_k10s40);
lag1Corr_QueueRatio10(1) = autocorrelation(queue_ratio_k10s40)
[R90_QR10(1), R95_QR10(1), R99_QR10(1)] = RelconfidenceIntv(queue_ratio_k10s40)
...
[R90_Load10(2), R95_Load10(2), R99_Load10(2)] = RelconfidenceIntv(load_k10s60)

% Queue Ratio

m_QueueRatio10(2)=mean(queue_ratio_k10s60);
lag1Corr_QueueRatio10(2) = autocorrelation(queue_ratio_k10s60)
[R90_QR10(2), R95_QR10(2), R99_QR10(2)] = RelconfidenceIntv(queue_ratio_k10s60)
...
[R90_Load10(3), R95_Load10(3), R99_Load10(3)] = RelconfidenceIntv(load_k10s80)

% Queue Ratio

m_QueueRatio10(3)= mean(queue_ratio_k10s80);
lag1Corr_QueueRatio10(3) = autocorrelation(queue_ratio_k10s80)
[R90_QR10(3), R95_QR10(3), R99_QR10(3)] = RelconfidenceIntv(queue_ratio_k10s80)
...
[R90_Load10(4), R95_Load10(4), R99_Load10(4)] = RelconfidenceIntv(load_k10s100)

% Queue Ratio

m_QueueRatio10(4)=mean(queue_ratio_k10s100);
lag1Corr_QueueRatio10(4) = autocorrelation(queue_ratio_k10s100)
[R90_QR10(4), R95_QR10(4), R99_QR10(4)] = RelconfidenceIntv(queue_ratio_k10s100)
...
[R90_Load10(5), R95_Load10(5), R99_Load10(5)] = RelconfidenceIntv(load_k10s120)

% Queue Ratio

m_QueueRatio10(5)=mean(queue_ratio_k10s120);
lag1Corr_QueueRatio10(5) = autocorrelation(queue_ratio_k10s120)
[R90_QR10(5), R95_QR10(5), R99_QR10(5)] = RelconfidenceIntv(queue_ratio_k10s120)
...
[R90_Load10(6), R95_Load10(6), R99_Load10(6)] = RelconfidenceIntv(load_k10s150)

% Queue Ratio

m_QueueRatio10(6)=mean(queue_ratio_k10s150);
lag1Corr_QueueRatio10(6) = autocorrelation(queue_ratio_k10s150)
[R90_QR10(6), R95_QR10(6), R99_QR10(6)] = RelconfidenceIntv(queue_ratio_k10s150)
...
xlabel('Service Time');
title('Effect of Queuing ratio on Rel. size(95% CI)')
legend('k=2','k=5','k=10')
grid on;
...
xlabel('Service Time');
title('Effect of Load on Rel. size(95% CI)')
legend('k=2','k=5','k=10')
grid on;
