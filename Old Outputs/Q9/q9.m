...
R95_1=ci12(2)-ci12(1)
Relative_CI1=R95_1/mean(loss_ratio_1)
% 99 ci
...
R95_2=ci22(2)-ci22(1)
Relative_CI2=R95_2/mean(loss_ratio_2)
% 99 ci
...
R95_3=ci32(2)-ci32(1)
Relative_CI3=R95_3/mean(loss_ratio_3)
% 99 ci
...
R95_4=ci42(2)-ci42(1)
Relative_CI4=R95_4/mean(loss_ratio_4)
% 99 ci
...
x=[25 40 60 80]
y=[Relative_CI1 Relative_CI2 Relative_CI3 Relative_CI4]
figure;
plot(x,y), axis([0 80 -1 2]);