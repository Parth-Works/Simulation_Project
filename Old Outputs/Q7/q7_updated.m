...
% impact of the size of loss ratio on the absolute sizes of the confidence intervals
...
figure;
plot(x,y1/2,'*-g','LineWidth',2), hold on,
plot(x,y2/2,'*-b','LineWidth',2), hold on,
plot(x,y3/2,'*-r','LineWidth',2);
title('Effect of Loss Ratio on Absolute sizes of confidence interval');legend('90% CI','95% CI','99% CI');
