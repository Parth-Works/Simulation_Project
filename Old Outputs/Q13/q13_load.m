...
% impact of the type of the source process (D, M, 1) and (U, M,1) on loss.
...
title('Effect of the type of the source process (D, M, 1) and (U, M,1) on loss on Load');legend('95% CI','Lag-1 Autocorrelation');
xlabel('Systems');
ylabel('Load');
grid on;
