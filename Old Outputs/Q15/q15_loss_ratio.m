...
% impact of the type of the server process (M, D, 1) and (M, U,1) on loss.
...
title('Effect of type of the server process (M, D, 1) and (M, U,1) on loss');legend('95% CI','Lag-1 Autocorrelation');
xlabel('Systems');
ylabel('Loss Ratio');
grid on;
