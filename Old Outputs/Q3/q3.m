...
%%%
%90 ci
MU101=fitdist(load_10,'Normal') 
ci101 = paramci(MU101,'Alpha',.1)
R90_10=ci101(2)-ci101(1)
%95 ci
MU102=fitdist(load_10,'Normal') 
ci102 = paramci(MU102,'Alpha',.05)
R95_10 = ci102(2)-ci102(1)

% 99 ci
MU103=fitdist(load_10,'Normal') 
ci103 = paramci(MU103,'Alpha',.01)
R99_10=ci103(2)-ci103(1)
...
x1=[50 100 200 500 700 1000 2500 5000 7500 10000 ];
x1 = categorical({'50','200','500','1000','2500','5000','10000'});
x1 = reordercats(x1,{'50','200','500','1000','2500','5000','10000'});
y1=[R90_2 R90_1 R90_3 R90_4 R90_7 R90_8 R90_10 ];
figure;
plot(x1,y1,'o-g','LineWidth',2);hold on;


x2=[50 100 200 500 700 1000 2500 5000 7500 10000 ];
x2 = categorical({'50','200','500','1000','2500','5000','10000'});
x2 = reordercats(x2,{'50','200','500','1000','2500','5000','10000'});
y2=[R95_2 R95_1 R95_3 R95_4 R95_7 R95_8 R95_10 ]

plot(x2,y2,'o-r','LineWidth',2);hold on;
%ylim([-0.1 0.5]);


x3=[50 100 200 500 700 1000 2500 5000 7500 10000 ]
x3 = categorical({'50','200','500','1000','2500','5000','10000'});
x3 = reordercats(x3,{'50','200','500','1000','2500','5000','10000'});
y3=[R99_2 R99_1 R99_3 R99_4 R99_7 R99_8 R99_10 ]

plot(x3,y3,'o-b','LineWidth',2);
